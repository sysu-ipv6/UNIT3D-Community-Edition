...
return [
    ...
    */
    ...
    'gt'                   => [
        ...
        'array'   => '该 :attribute 必须多于 :value 物件。',
    ],
    'gte'                  => [
        'numeric' => '该 :attribute 必须大过或等于 :value。',
        'file'    => '该 :attribute 必须大过或等于 :value kB。',
        'string'  => '该 :attribute 必须大过或等于 :value 字。',
        'array'   => '该 :attribute 必须多于或等于 :value 物件。',
    ],
    ...
    'lt'                   => [
        ...
        'array'   => '该 :attribute 必须少于 :value 物件。',
    ],
    'lte'                  => [
        'numeric' => '该 :attribute 必须小过或等于 :value。',
        'file'    => '该 :attribute 必须小过或等于 :value kB。',
        'string'  => '该 :attribute 必须小过或等于 :value 字。',
        'array'   => '该 :attribute 必须少于或等于 :value 物件。',
    ],
    'max'                  => [
        'numeric' => '该 :attribute 不可以大于 :max。',
        'file'    => '该 :attribute 不可以大于 :max KB。',
        'string'  => '该 :attribute 不可以大于 :max 字。',
    ...
    'size'                 => [
        ...
        'string'  => '该 :attribute 必须是 :size字。',
        'array'   => '该 :attribute 必须包含 :size 项目。',
    ],
    'starts_with'          => '该 :attribute 必须由这些起始: :values',
