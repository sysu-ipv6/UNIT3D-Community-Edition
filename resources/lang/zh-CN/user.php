...
return [
    ...
    'achievement-privacy-list'  => '允许其他用户浏览你的成就',
    'achievement-help'          => '调整能浏览你的成就的用户组。
    ...
    'followers'                 => '关注者',
    'following-notification'    => '关注者通知设定',
    ...
    若已<strong>取消全局性</strong>通知，以下设定将会无效。',
    'notification-from-request' => '收取来自求种的通知',
    'notification-from-request-help'           => '只从系统，管理员及以下勾选的用户组收取求种通知。
    若已<strong>取消全局性</strong>通知，以下设定将会无效。',
    'notifications'             => '通知',
    'offline'                   => '用户下线了！',
    'online'                    => '用户上线了！',
    ...
    'profile-privacy-torrent-count'        => '分享你的统计资料：下载总数，上传总数，做种数及下载情况',
    ...
    'profile-privacy-request-extra'       => '分享你的求种数据',
    ...
    'removed'                   => '解封时间',
    'report'                    => '举报用户',
    'request-help'              => '调整是否与其他有权浏览你个人资料组别的用户分享你的求种统计数据与信息。若已开启<strong>私密模式</strong>，以下设定将会无效。',
    'request'                   => '求种',
    'requested'                 => '求种',
    'requests'                  => '求种',
    'request-comments'          => '对求种作出的评论',
    'request-notification'      => '求种的通知设定',
    'request-notification-bounty' => '收取来自资源打赏的通知',
    'request-notification-comment' => '收取来自求种评论的通知',
    ...
    'title'                     => '头衔',
    'top-bankers'               => '壕排名',
    'top-downloaders-data'      => '流量排名',
    'top-leechers'              => '当前下载排名',
    'top-leechers-count'        => '当前下载排名（下载数量）',
    'top-seeders'               => '保种者排名',
    'top-seeders-count'         => '保种者排名（做种数量）',
    'top-seeding-size'          => '保种者排名（做种体积）',
    'top-seedtime'              => '做种时间排名',
    'top-uploaders-data'        => '上传者排名（流量）',
    'top-uploaders-count'       => '发布者排名',
    'topics'                    => '主题',
    ...
    'visible-to-request'        => '求种信息可见性',
    'visible-to-request-help'   => '只有站务人员或以下所勾选的组别才能浏览你的求种信息。若你启动了<strong>私密模式</strong>，以下设定将会无效。',
