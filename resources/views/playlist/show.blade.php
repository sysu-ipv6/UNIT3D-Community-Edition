			...
			<section class="inner_content header" style="background-image: url({{ $meta->backdrop ?? 'https://via.placeholder.com/1400x800' }});">
				<div class="bg_filter">
					<div class="single_column">
						...
						<h3 class="text-bold">@lang('playlists.about-list')</h3>
				...
				<div class="container-fluid">
					<form role="form" method="POST" action="{{ route('playlists.attach') }}">
						...
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">@lang('playlists.add')</h4>
						</div>
						<div class="modal-body">
							<div class="form-group">
								<label for="report_reason">@lang('playlists.torrent-id')</label>
							</div>
							<div class="form-group">
								<label>
